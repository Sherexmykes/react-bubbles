...
A token is nomarlly used for for web authentication. It lets users enter their username and password once and generates an encrypted token in exchange. The token is used to access protected pages or resources instead of the login credentials
.
- [ ] What steps can you take in your web apps to keep your data secure?
Create a token for the web app users so their data will be more secure.


- [ ] Describe how web servers work.
A web server processes incoming network requests over HTTP and several other related  protocols. It sends back the requested data to the requesting source.
